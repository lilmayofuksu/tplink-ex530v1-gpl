...
/* for channel code */
#if 0 /*modified by chenming, to fix Bug144389 of SFTP */
...
#else
#define TRANS_MAX_WINDOW 	0xFFFFFFFF /* from RFC4254 SSH Connection Protocol*/
#define TRANS_MAX_WIN_INCR 	0xFFFFFFFF /* overflow prevention */
#endif
