...
{
	printf(
"tpmark match options:\n"
"[!] --tpmark value[/mask]    Match nfmark value with optional mask\n");
}
...
static struct xtables_match tpmark_mt_reg[] = {
	{
...
void _init(void)
{
	xtables_register_matches(tpmark_mt_reg, ARRAY_SIZE(tpmark_mt_reg));
}
