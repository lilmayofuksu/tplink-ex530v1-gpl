...
/* 
 * brief	dingcheng@20140815
 * 		Use this cache to save all IP infos for the domain
 *		in order to try each for register
 */
typedef struct SRV_IP_CACHE
{
...
#	endif
	...
	int enableUseContactStar;  /* BosaZhong@17Jun2014, add, unreg before reg. */

#ifdef INCLUDE_ROBIN_DNS 
	/* dingcheng-pjsip.Use this cache to save IP infos for the domain  */
	SRV_IP_CACHE		srv_ipinfo;
#endif /* INCLUDE_ROBIN_DNS */
};
