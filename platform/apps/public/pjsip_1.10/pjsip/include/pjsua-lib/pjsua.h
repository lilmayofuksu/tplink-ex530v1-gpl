...
/* wlmtodo: use macro to control this */
#ifndef NUM_DECT_CHANNELS
//#error "NUM_DECT_CHANNELS is 0"
#define NUM_DECT_CHANNELS 6
#endif

/* wlmtodo:  use macro to control this */
#ifndef NUM_VOICEAPP_CHANNELS
#define NUM_VOICEAPP_CHANNELS 8
#endif
...
/*<< BosaZhong@21Jun2014, add, our own dns resolve. */
#ifndef PJ_MAX_NAMESERVER
#define PJ_MAX_NAMESERVER		4
#endif 
/*>> endof BosaZhong@21Jun2014, add, our own dns resolve. */
...
/*ycw @ 2012-04-05: Because we don't use sip resolver*/
     ...
     */
    pj_str_t	    nameserver[PJ_MAX_NAMESERVER];
#endif
...
typedef struct pjsua_transport_config
{
	...
	pj_str_t		bound_addr6;
	pj_str_t		bound_addr_netmask6;
...
#	endif
	...
	pjsua_transport_id  transport6_id;
	...
	/*<< BosaZhong@17Jun2014, add, UserAgentDomain. */
	pj_str_t userAgentDomain;
	/*>> endof BosaZhong@17Jun2014, add, UserAgentDomain. */

	/*<< BosaZhong@17Jun2014, add, unreg before ret. */
	unsigned int unregBeforeReg;
	/*>> endof BosaZhong@17Jun2014, add, unreg before ret. */
} pjsua_acc_config;
...
/**
 * Current IP can't be used for register. So we try next IP.
 *
 * @param rdata		current acc.
 *
 * @return		ret status.
 */
...
void pjsua_parseStrSipUri2(const pjsip_sip_uri *req_sip_uri, PJSUA_STR_SIP_URI* pParsedUri);
pj_bool_t pjsua_matchInAccHostIpList(pjsua_acc_id acc_id, char* matchedIp);

int pjsua_isForwardCall(pjsip_msg* msg, pj_bool_t* isIpCall, int af);
