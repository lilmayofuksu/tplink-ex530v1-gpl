...
#	endif
	...
	int forceUnregBeforeRegStartFlag; /* BosaZhong@17Jun2014, add, unreg before reg. */
	...
	/*liuqianhao: add for forbidden timer for account for HKBN*/
	pj_timer_entry forbiddenTimer;
	pj_bool_t has_acc_forbidden;
