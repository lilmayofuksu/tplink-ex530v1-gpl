...
/* open pjsip reolver by default */
/* When enabled, pjsip resovlver cann't resovle hostname through bound VoIP WAN.
 * BBA plateform support multi WAN connection, DNS resovle should use cnet_getHostByNameWithMark
 * (called by pj_gethostbyname).
 * Disable this to use pj_gethostbyname to do DNS resovle.
 */
 /* enbale by default */
