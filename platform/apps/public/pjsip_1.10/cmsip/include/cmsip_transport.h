...
extern int cmsip_send_regOrUnreg(int accId, CMSIP_SIP_REG_ACTION regOrUnreg);
 ...
 *	param[in]	af				The family of local/remote address.
 * param[in]	txUseSrtp		Indicate if SRTP will work in sending direction.
 * param[in]	rxUseSrtp		Indicate if SRTP will work in receiving direction.
 * param[in]	txSuite			Indicate SRTP policy in sending direction.
 * param[in]	rxSuite			Indicate SRTP policy in receiving direction.
 * param[in]	txKeySalt		Record SRTP master key and salt in sending direction.
 * param[in]	rxKeySalt		Record SRTP master key and salt in receiving direction.
 * param[out]	none
 *
 * return	
 * retval	
