...
#ifdef INCLUDE_FLASH_VOICEMAIL
#define USBDISK_FLASH_DIR		"/large_data/usbvm"
#endif
...
/*                                           TYPES                                                */
/**************************************************************************************************/
#define WAV_HEADER_LEN (16 + sizeof(UINT32) + sizeof(WAVEAUDIOFORMAT) + 8)
...
/*
 * brief	mark the voice mail entry read status.
 */
