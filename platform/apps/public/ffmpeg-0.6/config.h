...
#define FFMPEG_CONFIGURATION "--enable-static --enable-nonfree --enable-gpl --enable-pthreads --disable-shared --disable-encoders --disable-decoders --disable-debug --enable-cross-compile --cross-prefix=arm-openwrt-linux-uclibcgnueabi- --arch=arm --target-os=linux"
