...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-static --enable-nonfree --enable-gpl --enable-pthreads --disable-shared --disable-encoders --disable-decoders --disable-debug --enable-cross-compile --cross-prefix=arm-openwrt-linux-uclibcgnueabi- --arch=arm --target-os=linux
prefix=/usr/local
...
SRC_PATH=/home/dev/linux_qca_AC2600/apps/public/ffmpeg-0.6
SRC_PATH_BARE=/home/dev/linux_qca_AC2600/apps/public/ffmpeg-0.6
BUILD_ROOT=/home/dev/linux_qca_AC2600/apps/public/ffmpeg-0.6
ARCH=arm
...
CFLAGS=   -std=c99 -fomit-frame-pointer -marm -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -Werror=implicit -Werror=missing-prototypes 
ASFLAGS=  
CC_O=-o $@
LDFLAGS=  --as-needed -L/usr/mediaServer/referenceCode/build/../apps/ushare/mylib -L/usr/mediaServer/referenceCode/build/gcc-3.4.4-2.16.1/build_mips/lib -lgcc_s
