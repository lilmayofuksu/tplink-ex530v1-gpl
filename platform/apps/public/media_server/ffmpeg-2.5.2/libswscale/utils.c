...
// Don't use mmap(MAP_ANONYMOUS) to allocate memory, or anonymous pages may occupy too many memory.
// Since there is no swap area, the anonymous pages won't be swap out. It may cause OOM.
#if 1
#undef MAP_ANONYMOUS
#undef MAP_ANON
#endif
