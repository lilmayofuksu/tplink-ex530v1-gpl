...
/*                      DEFINES                      */
/***************************************************************************/
#define PCTL_OWNER_NUM                      (16)
#define PCTL_OWNER_ID_ALL                   0xffff

#define PCTL_CLIENT_NUM                     (256)
#define PCTL_URL_LIB_SIZE                   (3600)
#define PCTL_OWNER_BLOCKED_NUM              (32)
#define PCTL_TOTAL_BLOCKED_NUM              (512)
#define PCTL_OWNER_UNBLOCKED_NUM            (32)
#define PCTL_TOTAL_UNBLOCKED_NUM            (512)
#define PCTL_URL_LEN                        (64)
...
typedef struct _xt_pctl_info
{
    ...
    unsigned int    category;   /* Bitmap of url category. */

    /* Bitmap of blocked and unblocked url. */
    unsigned char   blocked_bitmap[PCTL_OWNER_BLOCKED_NUM];
    unsigned char   unblocked_bitmap[PCTL_OWNER_UNBLOCKED_NUM];
