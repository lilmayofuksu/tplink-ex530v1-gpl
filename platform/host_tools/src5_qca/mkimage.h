...
{	
	...
	UINT32 bootAddress;		/* starting address (offset) of bootloader image */
	...
	UINT32 sblAddress;          /*starting address (offset) of sbl image */
	UINT32 sblLen;              /*length of sbl image*/
	UINT32 mibibAddress;        /*starting address (offset) of mibib(nand system partition file)*/
	UINT32 mibibLen;            /*length of mibib*/
	UINT32 bootCfgAddress;      /*boot config address offset of image*/
	UINT32 bootCfgLen;          /*boot config length*/
	UINT32 qseeAddress;         /*starting address of qsee of image*/
	UINT32 qseeLen;             /*length of qsee*/
	UINT32 devCfgAddress;       /*starting address of dev config of image*/
	UINT32 devCfgLen;           /*length of device config*/
	...
	UINT32 cdtAddress;          /*starting address of cdt of image*/
	UINT32 cdtLen;              /*length of cdt*/

	UINT32 dmVersion;      /* from Device.DeviceInfo.X_TP_DMVersion */
	UINT32 prehookFsAddress;  /* squashfs address for prehook exes */
	UINT32 prehookFsLen;      /* squashfs length for prehook exes */

	UINT32 reserved2[7];	/* reserved for future */
}LINUX_FILE_TAG;
