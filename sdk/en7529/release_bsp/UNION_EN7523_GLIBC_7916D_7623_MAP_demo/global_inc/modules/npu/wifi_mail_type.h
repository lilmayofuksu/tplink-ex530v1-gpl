...
typedef enum {
	...
	WIFI_MAIL_FUNCTION_SET_WAIT_DRAM_BA_ENTRY_ADDR,
...
typedef struct counter {
...
#ifdef TCSUPPORT_NPU_WIFI_OFFLOAD	
	unsigned long rxCount2G[MAX_SSID_PER_BAND];
	unsigned long rxCount5G[MAX_SSID_PER_BAND];
	...
	unsigned long rx_pkts_entry[2][MAX_PER_ENTRY];	
