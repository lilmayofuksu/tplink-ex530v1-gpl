...
static int add_sch_ep(int rh_port_num, int dev_speed, int is_in, int isTT, int ep_type, int maxp, int interval, int burst
...
static int count_hs_bw(int ep_type, int maxp, int interval, int offset, int td_size, struct sch_port *u3h_sch_port){
	int i;
	int bw_required;
	struct sch_ep *cur_sch_ep;
	int tmp_offset;
...
static int count_tt_isoc_bw(int is_in, int maxp, int interval, int offset, int td_size, struct sch_port *u3h_sch_port){
	char is_cs;
...
static int count_tt_intr_bw(int interval, int frame_offset, struct sch_port *u3h_sch_port){
