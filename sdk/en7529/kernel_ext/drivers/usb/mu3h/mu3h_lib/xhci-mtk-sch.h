...
#ifndef _XHCI_MTK_SCH_H_
#define _XHCI_MTK_SCH_H_
#define CONFIG_USB_XHCI_MTK 

#include "xhci.h"

#define MASK_ROOT_HUB_PORT (0xff<<16)
#define GET_ROOT_HUB_PORT(p) (((p) & MASK_ROOT_HUB_PORT)>>16)
