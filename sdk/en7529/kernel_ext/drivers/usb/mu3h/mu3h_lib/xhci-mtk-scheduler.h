...
int xhci_mtk_add_ep_quirk(struct usb_hcd *hcd, struct usb_device *udev,struct usb_host_endpoint *ep);
int mtk_xhci_scheduler_remove_ep(struct usb_hcd *hcd, struct usb_device *udev, struct usb_host_endpoint *ep);
#define mtk_xhci_scheduler_add_ep xhci_mtk_add_ep_quirk
