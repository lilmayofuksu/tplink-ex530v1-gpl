...
#if defined CONFIG_PROJECT_7662 || defined CONFIG_PROJECT_5399 || defined CONFIG_PROJECT_7621 || defined CONFIG_PROJECT_6595
...
#define PHY_BASE_P1				0xBFA90000
#define SIFSLV_FM_FEG_BASE_P1	(PHY_BASE_P1+0x100)
#define SIFSLV_CHIP_BASE_P1		(PHY_BASE_P1+0x800)
#define U2_PHY_BASE_P1			(PHY_BASE_P1+0x0300)
#define U3_PHYD_BASE_P1			(PHY_BASE_P1+0x0900)
#define U3_PHYD_B2_BASE_P1		(PHY_BASE_P1+0x0a00)
#define U3_PHYA_BASE_P1			(PHY_BASE_P1+0x0b00)
#define U3_PHYA_DA_BASE_P1		(PHY_BASE_P1+0x0c00)

/*EN7580 RG location used for u2 slew rate calibration*/
#define RG_USB20_HSTX_SRCAL_EN_ADDR 	0xbfa80314
#define RG_USB20_HSTX_SRCTRL_ADDR 		0xbfa80314
#define RG_FRCK_EN_ADDR 				0xbfa80110
#define RG_CYCLECNT_ADDR 				0xbfa80100
#define RG_FREQDET_EN_ADDR 			0xbfa80100
#define FM_OUT_ADDR 						0xbfa8010c
/*EN7580 USB init*/
#define RG_USB20_BC11_SW_EN_ADDR		0xbfa80318
#define RG_USB20_INTR_EN_ADDR			0xbfa80300
#define RG_SSUSB_IEXT_INTR_CTRL_ADDR	0xbfa80b00
#define RG_USB20_HS_100U_U3_EN_ADDR	0xbfa80314
#define RG_USB20_INTR_CAL_ADDR			0xbfa80304
#define RG_SSUSB_INTR_EN_ADDR			0xbfa80b00
#define RG_SSUSB_LN0_TX_IMP_SEL_ADDR	0xbfa80910
#define RG_SSUSB_LN0_RX_IMP_SEL_ADDR	0xbfa80914
...
#define RG_MONCLK_SEL                             		(0x1<<9) //9:9

#define RG_USB20_HSTX_SRCAL_EN_OFST       (15)
#define RG_USB20_HSTX_SRCTRL_OFST          	(12)
#define RG_MONCLK_SEL_OFST                        	(9)
#endif




#else //for ARM CPU, 7523
...
#define RG_SSUSB_LN0_TX_IMP_SEL			(0x1f<<24) //28:24
#define RG_SSUSB_LN0_RX_IMP_SEL		(0x1f<<24) //28:24
