...
#define QOSTYPE_IOC_SET_TEMPLATE_WAN _IOR(QOSTYPE_IOC_MAGIC,11,unsigned long)
...
#define QOSDSLIMIT_IOC_QUEUECFG_UP _IOR(QOSDSLIMIT_IOC_MAGIC, 5, unsigned long)
...
struct qos_match
{
	...
	int type_protocol_type;
	/* 
	0~5 bits used for DSCP
	6~6 bits used for DSCP switch flag
	8~11 bits used for 802.1p
	12~15 bits used for queue index
	*/
	int type_mask;
};
