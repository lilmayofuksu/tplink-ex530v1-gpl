...
static int mtk_pcie_probe(struct platform_device *pdev)
{
	...
	pcie_read_config_word_extend(0,0,0,0x90);
	pcie_read_config_word_extend(0,1,0,0x90);
	pcie_read_config_word_extend(1,0,0,0x0);
	pcie_read_config_word_extend(2,0,0,0x0);
...
static const struct of_device_id mtk_pcie_ids[] = {
	{ .compatible = "ecnt,pcie-en7523", .data = &mtk_pcie_soc_v2 },
	{},
};
