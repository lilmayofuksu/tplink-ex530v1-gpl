...
#define SF_CLK_CHANGE				(0xBFA201B8)
...
#define SF_READ_MODE_VALUE				SNOR_RDL(SF_READ_MODE)
#define SF_READ_IDLE_EN_VALUE     		SNOR_RDL(SF_READ_IDLE_EN)
#define SF_SIDLY_VALUE		     		SNOR_RDL(SF_SIDLY)
#define SF_CSHEXT_VALUE					SNOR_RDL(SF_CSHEXT)
#define SF_CSLEXT_VALUE					SNOR_RDL(SF_CSLEXT)
#define SF_MTX_MODE_TOG_VALUE			SNOR_RDL(SF_MTX_MODE_TOG)
#define SF_RDCTL_FSM_VALUE				SNOR_RDL(SF_RDCTL_FSM)
#define SF_MACMUX_SEL_VALUE				SNOR_RDL(SF_MACMUX_SEL)
#define SF_MANUAL_EN_VALUE				SNOR_RDL(SF_MANUAL_EN)
#define SF_MANUAL_OPFIFO_EMPTY_VALUE	SNOR_RDL(SF_MANUAL_OPFIFO_EMPTY)
#define SF_MANUAL_OPFIFO_WDATA_VALUE	SNOR_RDL(SF_MANUAL_OPFIFO_WDATA)
#define SF_MANUAL_OPFIFO_FULL_VALUE		SNOR_RDL(SF_MANUAL_OPFIFO_FULL)
#define SF_MANUAL_OPFIFO_WR_VALUE		SNOR_RDL(SF_MANUAL_OPFIFO_WR)
#define SF_MANUAL_DFIFO_FULL_VALUE		SNOR_RDL(SF_MANUAL_DFIFO_FULL)
#define SF_MANUAL_DFIFO_WDATA_VALUE		SNOR_RDL(SF_MANUAL_DFIFO_WDATA)
#define SF_MANUAL_DFIFO_EMPTY_VALUE		SNOR_RDL(SF_MANUAL_DFIFO_EMPTY)
#define SF_MANUAL_DFIFO_RD_VALUE		SNOR_RDL(SF_MANUAL_DFIFO_RD)
#define SF_MANUAL_DFIFO_RDATA_VALUE		SNOR_RDL(SF_MANUAL_DFIFO_RDATA)
#define SF_DUMMY_VALUE					SNOR_RDL(SF_DUMMY)
#define SF_ADDR_3B4B_VALUE				SNOR_RDL(SF_ADDR_3B4B)
#define SF_PROBE_SEL_VALUE				SNOR_RDL(SF_PROBE_SEL)
#define SF_CFG3B4B_EN_VALUE				SNOR_RDL(SF_CFG3B4B_EN)
#define SF_INTERRUPT_VALUE				SNOR_RDL(SF_INTERRUPT)
#define SF_INTERRUPT_EN_VALUE			SNOR_RDL(SF_INTERRUPT_EN)
#define SF_SI_CK_SEL_VALUE				SNOR_RDL(SF_SI_CK_SEL)
#define SF_CLK_CHANGE_VALUE				SNOR_RDL(SF_CLK_CHANGE)
...
#define SEND_OPFIFO_WRITE_CMD(op_cmd, op_len) ISSUE_OPFIFO_WRITE_CMD(op_cmd, op_len)
// Send dfifo write command
#define SEND_DFIFO_WRITE_CMD(data) ISSUE_DFIFO_WRITE_CMD(data)
// Send dfifo read command
#define SEND_DFIFO_READ_CMD(data) ISSUE_DFIFO_READ_CMD(data)
...
#define SEND_OPFIFO_WRITE_CMD(op_cmd, op_len)                														 \
        {                                                   														 \
          ...
          SNOR_WRL(SF_MANUAL_OPFIFO_WDATA, ((((op_cmd) & OP_CMD_MASK) << OP_SHIFT) | ((op_len) & OP_LEN_MASK)));  	 \
         /* wait until opfifo is not full */																				 \
          while(SNOR_RDL(SF_MANUAL_OPFIFO_FULL)) ; 																		 \
      	 /* enable write from register OPFIFO_WDATA to opfifo */														 \
          SNOR_WRL(SF_MANUAL_OPFIFO_WR, OP_ENABLE);       			 													 \
		/* wait until opfifo is empty */																					 \
          while(!SNOR_RDL(SF_MANUAL_OPFIFO_EMPTY));																		 \
        }
...
#define SEND_DFIFO_WRITE_CMD(data)                					 \
        {                                                   		 \
         /* wait until dfifo is not full */								 \
          while(SNOR_RDL(SF_MANUAL_DFIFO_FULL)) ; 					 \
       	 /* write data  to register DFIFO_WDATA */					 \
          SNOR_WRL(SF_MANUAL_DFIFO_WDATA, ((data) & DDATA_MASK));  	 \
        }
// Send dfifo read command
// Parameters:
//		data:	type is char
#define SEND_DFIFO_READ_CMD(data)                					 \
        {                                                   		 \
         /* wait until dfifo is not empty */								 \
          while(SNOR_RDL(SF_MANUAL_DFIFO_EMPTY)) ; 					 \
       	 /* read from dfifo to register DFIFO_RDATA */					 \
          (data) = SNOR_RDL(SF_MANUAL_DFIFO_RDATA);	  				 \
       	 /* enable register DFIFO_RD to read next byte */				 \
          SNOR_WRL(SF_MANUAL_DFIFO_RD, DDATA_ENABLE);	  			 \
        }
...
#define SEND_AUTO2MANUAL_CMD ISSUE_AUTO_MANUAL_CMD(1)
// change from manual mode 2 auto mode
#define SEND_MANUAL2AUTO_CMD ISSUE_AUTO_MANUAL_CMD(0)
// change auto mode to 3Byte address
#define SEND_AUTO_3B_CMD ISSUE_AUTO_3B_4B_CMD(1)
// change auto mode to 4Byte address
#define SEND_AUTO_4B_CMD ISSUE_AUTO_3B_4B_CMD(0)
// change Tn Value
#define SEND_TN_CMD(data) ISSUE_TN_CMD(data)
// Enable Auto Mode Read Idle Capability
#define SEND_READ_IDLE_EN_CMD ISSUE_READ_IDLE_EN_DIS_CMD(1)
// Disable Auto Mode Read Idle Capability
#define SEND_READ_IDLE_DIS_CMD ISSUE_READ_IDLE_EN_DIS_CMD(0)
// change auto mode to Read
#define SEND_AUTO_READ_CMD ISSUE_AUTO_MODE_CMD(auto_read)
// change auto mode to Fast Read
#define SEND_AUTO_FASTREAD_CMD ISSUE_AUTO_MODE_CMD(auto_fastread)
// change auto mode to Fast Read Dual Output
#define SEND_AUTO_FASTREAD_DUALOUT_CMD ISSUE_AUTO_MODE_CMD(auto_fastread_dualout)
// change auto mode to Fast Read Dual IO
#define SEND_AUTO_FASTREAD_DUALIO_CMD ISSUE_AUTO_MODE_CMD(auto_fastread_dualio)
...
#define SEND_AUTO2MANUAL_CMD									\
        {														\
          ...
          SNOR_WRL(SF_MTX_MODE_TOG, MANUAL_MTXMODE);			\
      	 /* enable Manual mode */								\
          SNOR_WRL(SF_MANUAL_EN, MANUAL_MANUALEN);				\
        }
...
#define SEND_MANUAL2AUTO_CMD									\
        {														\
          ...
          SNOR_WRL(SF_MTX_MODE_TOG, AUTO_MTXMODE);				\
      	 /* enable auto mode */									\
          SNOR_WRL(SF_MANUAL_EN, AUTO_MANUALEN);				\
        }
...
#define SEND_AUTO_3B_CMD										\
        {														\
          ...
          SNOR_WRL(SF_CFG3B4B_EN, CFG3B4B_EN);					\
      	 /* aauto address is 3Byte */								\
          SNOR_WRL(SF_ADDR_3B4B, AUTO_3BMODE);					\
        }
...
#define SEND_TN_CMD(data)										\
        {														\
          ...
          SNOR_WRL(SF_SI_CK_SEL, ((data) & SI_SEL_MASK));		\
        }
...
#define SEND_AUTO_4B_CMD										\
        {														\
          ...
          SNOR_WRL(SF_ADDR_3B4B, AUTO_4BMODE);					\
        }
...
#define SEND_READ_IDLE_EN_CMD									\
        {														\
      	 /* Enalbe Read IDLE */									\
          SNOR_WRL(SF_READ_IDLE_EN, RD_IDLE_EN);				\
        }
...
#define SEND_READ_IDLE_DIS_CMD									\
        {														\
      	 /* Disable Read IDLE */									\
          SNOR_WRL(SF_READ_IDLE_EN, RD_IDLE_DIS);				\
        }
...
#define SEND_AUTO_READ_CMD										\
        {														\
      	 /* auto mode is Read */									\
          SNOR_WRL(SF_READ_MODE, AUTO_READ);					\
        }
...
#define SEND_AUTO_FASTREAD_CMD									\
        {														\
          ...
          SNOR_WRL(SF_READ_MODE, AUTO_FAST_READ);				\
        }
...
#define SEND_AUTO_FASTREAD_DUALOUT_CMD							\
        {														\
          ...
          SNOR_WRL(SF_READ_MODE, AUTO_FAST_READ_DUALOUT);		\
        }
...
#define SEND_AUTO_FASTREAD_DUALIO_CMD							\
        {														\
          ...
          SNOR_WRL(SF_READ_MODE, AUTO_FAST_READ_DUALIO);		\
        }
