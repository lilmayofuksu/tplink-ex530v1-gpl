...
int pciePreConfigReg(void)
{
	...
	*/
	...
	if(isMT751020 || isRT63368 || isEN751221 || isEN751627 || isEN7580)
	{	
...
int pcie_write_config_word(unsigned char type, unsigned char bus, unsigned char devnum, unsigned int regnum, unsigned long int value)
{
	if (isEN751221 || isEN751627 || isEN7580)
...
ahbErrChk(void){
	...
	if(isRT63365 ||  isMT7505 || isEN751221 || isEN751627 || isEN7580)
		return;
