...
void init_7528(void)
{		
	printk("PCIe 7528 PHY init  \n");
	// copy 751221 setting: LCDDS_CLK_PH_INV
	regWrite32(0xbfaf24a0,  ((regRead32(0xbfaf24a0) &(~(0x1<<5)) )|(0x1<<5) ));
	mdelay(1);

	//combo phy Rx R FT mean value too high, tune target R -5 ohm
	regWrite32(0xbfac0b2c,  ((regRead32(0xbfac0b2c) &(~(0x3<<12)) )|(0x1<<12) ));
	mdelay(1);
...
void init_7580(void)
{		
	printk("PCIe 7580 PHY init  \n");
	//RG_PCIE_CLKDRV_OFFSET [31:30] = 2'b10 for clk crossing test; Biker_20180522
	regWrite32(0xbfaf2b2c, (regRead32(0xbfaf2b2c) |(0x2 <<30))); //port 0
	regWrite32(0xbfac0b2c, (regRead32(0xbfac0b2c) |(0x2 <<30))); //port 1

	//L1SS  CDR stable issue from DR, Biker_20180716
	regWrite32(0xbfaf2950,  ((regRead32(0xbfaf2950) &(~(0x7ff)) )|(0x50) )); //port 0
	regWrite32(0xbfac0950,  ((regRead32(0xbfac0950) &(~(0x7ff)) )|(0x50) )); //port 1

	//Read Efuse then write to tx_impsel, rx_impsel, Biker_20180814
#if defined(TCSUPPORT_CPU_EN7580)
	if (get_efuse_data(DA_SSUSB_LN0_TX_IMP_SEL_PCIE_P0) != 0)
	{
		regWrite32(0xbfaf2910, regRead32(0xbfaf2910)&(~(0x1f<<24) )|((get_efuse_data(DA_SSUSB_LN0_TX_IMP_SEL_PCIE_P0))<<24));
		mdelay(1);
	}
	
	if (get_efuse_data(DA_SSUSB_LN0_RX_IMP_SEL_PCIE_P0) != 0)
	{
		regWrite32(0xbfaf2914, regRead32(0xbfaf2914)&(~(0x1f<<24) )|((get_efuse_data(DA_SSUSB_LN0_RX_IMP_SEL_PCIE_P0))<<24));
		mdelay(1);
	}
	
	if (get_efuse_data(RG_SSUB_IEXT_INTR_CTRL_PCIE_P0) > 23)
	{	
		regWrite32(0xbfaf2b00, regRead32(0xbfaf2b00)&(~(0x3f<<10) )|((get_efuse_data(RG_SSUB_IEXT_INTR_CTRL_PCIE_P0))<<10));
		mdelay(1);
	}
	
	if (get_efuse_data(DA_SSUSB_LN0_TX_IMP_SEL_PCIE_P1) != 0)
	{
		regWrite32(0xbfac0910, regRead32(0xbfac0910)&(~(0x1f<<24) )|((get_efuse_data(DA_SSUSB_LN0_TX_IMP_SEL_PCIE_P1))<<24));
		mdelay(1);
	}
	if (get_efuse_data(DA_SSUSB_LN0_RX_IMP_SEL_PCIE_P1) != 0)
	{
		regWrite32(0xbfac0914, regRead32(0xbfac0914)&(~(0x1f<<24) )|((get_efuse_data(DA_SSUSB_LN0_RX_IMP_SEL_PCIE_P1))<<24));
		mdelay(1);
	}
	
	if (get_efuse_data(RG_SSUB_IEXT_INTR_CTRL_PCIE_P1) > 23)
	{
		regWrite32(0xbfac0b00, regRead32(0xbfac0b00)&(~(0x3f<<10) )|((get_efuse_data(RG_SSUB_IEXT_INTR_CTRL_PCIE_P1))<<10));
		mdelay(1);
	}
	
	printk("Read PCIe impedance setting \n");
	printk("TX_IMP_SEL_PCIE_P0 0xbfaf2910 [28:24]:0x%x \n", (regRead32(0xbfaf2910)>>24) &0x1f);	
	printk("RX_IMP_SEL_PCIE_P0 0xbfaf2914 [28:24]:0x%x \n", (regRead32(0xbfaf2914)>>24)&0x1f);
	printk("INTR_CTRL_PCIE_P0 0xbfaf2b00 [15:10]:0x%x \n",  (regRead32(0xbfaf2b00)>>10)&0x3f);
	printk("TX_IMP_SEL_PCIE_P1 0xbfac0910 [28:24]:0x%x \n", (regRead32(0xbfac0910)>>24)&0x1f);
	printk("RX_IMP_SEL_PCIE_P1 0xbfac0914 [28:24]:0x%x \n", (regRead32(0xbfac0914)>>24)&0x1f);
	printk("INTR_CTRL_PCIE_P1 0xbfac0b00 [15:10]:0x%x \n", (regRead32(0xbfac0b00)>>10)&0x3f);
...
int pciePhyInit(void){
	...
	if(isFPGA) {
		...
		init_7528();
		printk("PCIe driver version: 7528.2.20190226\n");
		...
		init_7580();
		printk("PCIe driver version: 7580.4.20181030\n");
