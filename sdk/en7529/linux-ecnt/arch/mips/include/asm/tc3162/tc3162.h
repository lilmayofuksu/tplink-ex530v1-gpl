...
#define PDIDR				(regRead32(0xBFB0005C)&(0xFFFF))
...
/* EN7580 */
#define isEN7580GT	(isEN7580 && (GET_PACKAGE_ID == 0x0))
#define isEN7580ST	(isEN7580 && (GET_PACKAGE_ID == 0x1))
#define isEN7580GAT	(isEN7580 && (GET_PACKAGE_ID == 0x2))
#define isEN7565	(isEN7580 && (GET_PACKAGE_ID == 0x3))
#define isEN7528GT_EN7580	(isEN7580 && (GET_PACKAGE_ID == 0x4))


#define isEN7527H ((isEN751627 && !isEN7528 && isEN751627QFP) && ( (regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT_7516)? \
                        (((regRead32(EFUSE_VERIFY_DATA0)>>EFUSE_PKG_REMARK_SHITF_7516)& EFUSE_PKG_MASK_7516)== EFUSE_EN7527H): \
                        ((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_PKG_MASK_7516)==EFUSE_EN7527H)))
#define isEN7527G ((isEN751627 && !isEN7528 && !isEN751627QFP) && ( (regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT_7516)? \
                        (((regRead32(EFUSE_VERIFY_DATA0)>>EFUSE_PKG_REMARK_SHITF_7516)& EFUSE_PKG_MASK_7516)== EFUSE_EN7527G): \
                        ((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_PKG_MASK_7516)==EFUSE_EN7527G)))
#define isEN7561G ((isEN751627 && !isEN7528 && !isEN751627QFP) && ( (regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT_7516)? \
							(((regRead32(EFUSE_VERIFY_DATA0)>>EFUSE_PKG_REMARK_SHITF_7516)& EFUSE_PKG_MASK_7516)== EFUSE_EN7561G): \
							((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_PKG_MASK_7516)==EFUSE_EN7561G)))
#define isEN7516G (isEN751627 && !isEN7528 && ( (regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT_7516)? \
                        (((regRead32(EFUSE_VERIFY_DATA0)>>EFUSE_PKG_REMARK_SHITF_7516)& EFUSE_PKG_MASK_7516)== EFUSE_EN7516G): \
                        ((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_PKG_MASK_7516)==EFUSE_EN7516G)))
#define isEN7526F (isEN7526c? \
				...
				((isEN751221 && ( (regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT)? \
                        ...
                        ((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_PKG_MASK)==EFUSE_EN7526F)))|| (isEN7526FT)))
#define isEN7526FC_U2 (isEN7526c && (((VPint(0xBFA201EC) & (1<<10)))==0))
 #define isEN7526FP (isEN7526c & isEN7526F & (((VPint(0xBFA201EC) & (1<<10)))==(1<<10)))
#define isEN7526FT_C    ( isEN7526c & ((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT)? \
                        (((regRead32(EFUSE_VERIFY_DATA1)>>10)&0x1)== 0x1): \
                        (((regRead32(EFUSE_VERIFY_DATA1)>>9)&0x1)==0x1)))
...
#define isEN7521FCUD (isEN7526c && isEN7521F &&  EFUSE_IS_DDR3)
...
#define isEN7526FT (isEN751221 && ( (regRead32(EFUSE_VERIFY_DATA0)&EFUSE_REMARK_BIT)? \
                        (((regRead32(EFUSE_VERIFY_DATA0)>>EFUSE_PKG_REMARK_SHITF)& EFUSE_PKG_MASK)== EFUSE_EN7526FT): \
                        ((regRead32(EFUSE_VERIFY_DATA0)&EFUSE_PKG_MASK)==EFUSE_EN7526FT)))
...
#define SET_PACKAGE_ID(x)				(GET_PACKAGE_ID = (x & 0xF))
...
#define POWER_SAVING_NORMAL				(0)
#define POWER_SAVING_P1					(1)
#define POWER_SAVING_P2					(2)

#define POWER_SAVING_MODE_SHIFT			(0x0)
#define POWER_SAVING_MODE_MASK			(0x3)

#define REG_WDOG_FREE_SAVE_INFO			(0xBFB00240)
#define GET_POWER_SAVING				((VPint(REG_WDOG_FREE_SAVE_INFO) >> POWER_SAVING_MODE_SHIFT) & POWER_SAVING_MODE_MASK)
...
#define isParallelNAND				(!(VPint(0xBFA1155C) & 0x4))
#else
#define isParallelNAND				0
#endif

#if defined(TCSUPPORT_CPU_EN7512) || defined(TCSUPPORT_CPU_EN7521)
#define IS_SPIFLASH		!(IS_NANDFLASH)
#define IS_NANDFLASH		((VPint(0xBFA10114) & 0x2) || isParallelNAND)
...
#define uartTxIntOn()		UART_RDL(CR_UART_IER) |= IER_THRE_INTERRUPT_ENABLE
#define uartTxIntOff()		UART_RDL(CR_UART_IER) &= ~IER_THRE_INTERRUPT_ENABLE
#define uartRxIntOn()		UART_RDL(CR_UART_IER) |= IER_RECEIVED_DATA_INTERRUPT_ENABLE
#define	uartRxIntOff()		UART_RDL(CR_UART_IER) &= ~IER_RECEIVED_DATA_INTERRUPT_ENABLE
...
#endif
#if defined(TCSUPPORT_CPU_EN7580)
#define CR_AHB_HWCONF       (isFPGA ? 0xBFA2FF30 : 0xBFA20254)
