...
WPS_BTN_NOT_SUPPORT_5G=y
# TCSUPPORT_WPS_5G_BTN is not set
# TCSUPPORT_WPS_BTN_DUALBAND is not set
...
# TCSUPPORT_WLAN_WPA3 is not set
# TCSUPPORT_WLAN_AX is not set
...
# TCSUPPORT_FIRST_IF_MT7915N is not set
...
# TCSUPPORT_WLAN_MT7592_V4123 is not set
...
TCSUPPORT_PARTITIONS_CMDLINE_STR="25m[tclinux],25m[tclinux_slave],1m[config]"
...
# TCSUPPORT_CT_IPOE_DETECT is not set
