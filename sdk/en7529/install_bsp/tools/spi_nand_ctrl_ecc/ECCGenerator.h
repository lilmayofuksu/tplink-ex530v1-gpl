...
* Description:
* ------------
* This file is used to calculate ECC 
*
* Author:
* -------
...
//inBuf: input data to calculate ECC, 512 + 8 length for each sector
//outBuf_Post_Proc: output data, ECC result, 8 length for each sector
//encode_size_in_byte: 512 + 8 length for each sector
//encode_capability: 4
