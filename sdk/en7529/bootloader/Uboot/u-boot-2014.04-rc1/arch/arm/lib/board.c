...
#if defined(INCLUDE_BOOT_AGINETCONFIG)
	CPEinit(NetOurEther, 3, 3000);
#endif

#ifdef CONFIG_ECNT_MULTIUPGRADE
	time_init();
#endif //#ifdef CONFIG_ECNT_MULTIUPGRADE
#endif //#if defined(CONFIG_USE_IRQ)
#endif //#if defined(CONFIG_ECNT)
