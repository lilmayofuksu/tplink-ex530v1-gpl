...
#if defined(CONFIG_ARMV7_LPAE) && !defined(PGTABLE_SIZE) && defined(CONFIG_ECNT)
...
#if defined(CONFIG_ARMV7_LPAE) && defined(CONFIG_ECNT)
...
#elif defined(CONFIG_CPU_V7) && defined(CONFIG_ECNT)
...
enum dcache_option {
	...
	DCACHE_WRITETHROUGH = TTB_SECT_DOMAIN(1) | TTB_SECT | TTB_SECT_C_MASK,
...
#if defined(CONFIG_CPU_V7) && defined(CONFIG_ECNT)
/* TTBR0 bits */
