...
#define CONFIG_HWFWD_DSCP_NUM				(32) //shoule not less than 16 for EN7580
#define CONFIG_HWFWD_DSCP_SIZE				(16) 
...
#define K0_TO_K1(x)					x //	(((uint32)x) | 0xa0000000)
#define K1_TO_PHY(x)				x //	(((uint32)x) & 0x1fffffff)
...
/*******************************************************************
 ***                                       QDMA Reg Realted Start                                       ***
 *******************************************************************/

#define CONFIG_QDMA_BASE_ADDR                       (0x1FB54000)
#define QDMA_REG_BASE                               (0x1FB54000)
...
#define QDMA_CSR_RX_DSCP_BASE(base, idx)			(base+0x000C+RING_OFFSET(idx)) //7516 only for rx0, rx1
...
#define QDMA_CSR_RX_CPU_IDX(base, idx)				(base+0x0018+RING_OFFSET(idx)) //7516 only for rx0, rx1
#define QDMA_CSR_RX_DMA_IDX(base, idx)				(base+0x001C+RING_OFFSET(idx)) //7516 only for rx0, rx1
...
#define IOMUX_CONTROL1      0x1FA20210
#define LAN_LED0            0x550
#define LAN_LED1            0x2AA0
#define LAN_LED             LAN_LED0
#elif defined(TCSUPPORT_CPU_EN7580)
#define IOMUX_CONTROL1      0xBFA20210
#define LAN_LED0            0x550
#define LAN_LED1            0x2AA0
#define LAN_LED             LAN_LED0
#elif defined(TCSUPPORT_CPU_EN7516)||defined(TCSUPPORT_CPU_EN7527)
#define IOMUX_CONTROL1      0xBFA2015C
#define LAN_LED0            0x1550
#define LAN_LED1            0x2AA0
#define LAN_LED             LAN_LED1
#else
