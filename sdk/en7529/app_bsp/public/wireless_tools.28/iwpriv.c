...
u_char	buffer[32768] = {0};	/* Only that big in v25 and later */
		...
		int		priv_num)	/* Number of descriptions */
{
  ...
  if((priv[k].set_args & IW_PRIV_SIZE_FIXED) &&
      ...
      else
	{
	  ...
	  {
		 m_buffer = (u_char*)(malloc(sizeof(u_char)*32768));
		if (NULL == m_buffer)
        {
