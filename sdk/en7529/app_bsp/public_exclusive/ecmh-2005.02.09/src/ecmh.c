...
***************************************
 $Author: aaron.zhang $
 $Id: //BBN_Linux/Branch/Branch_for_New_ECNT_Kernel4_4_7527BSP_20180411/tclinux_phoenix/apps/public/ecmh-2005.02.09/src/ecmh.c#1 $
 $Date: 2018/04/11 $
***************************************
...
void l4_ipv6_icmpv6_mld1_reduction(struct intnode *intn, const struct ip6_hdr *iph, const uint16_t len, struct mld1 *mld1, const uint16_t plen, const unsigned char* mac)
{
	...
	system("echo 4 > /proc/tc3162/hwnat_off");
