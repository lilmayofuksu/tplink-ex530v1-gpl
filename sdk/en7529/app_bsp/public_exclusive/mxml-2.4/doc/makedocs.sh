#!/bin/sh
#
# "$Id: //BBN_Linux/DEV/main/tclinux_phoenix/apps/public/mxml-2.4/doc/makedocs.sh#1 $"
#
...
#
# End of "$Id: //BBN_Linux/DEV/main/tclinux_phoenix/apps/public/mxml-2.4/doc/makedocs.sh#1 $".
#
