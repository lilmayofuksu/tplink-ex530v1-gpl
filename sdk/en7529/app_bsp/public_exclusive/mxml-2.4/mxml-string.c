/*
 * "$Id: //BBN_Linux/DEV/main/tclinux_phoenix/apps/public/mxml-2.4/mxml-string.c#1 $"
 *
...
/*
 * End of "$Id: //BBN_Linux/DEV/main/tclinux_phoenix/apps/public/mxml-2.4/mxml-string.c#1 $".
 */
