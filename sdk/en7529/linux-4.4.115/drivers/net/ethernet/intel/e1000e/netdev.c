...
#ifdef CONFIG_PCI_MSI
unsigned int VPint_r(void *virtAddr);
unsigned int VPint_w(void *virtAddr,unsigned int value);
...
static irqreturn_t e1000_intr_msi(int __always_unused irq, void *data)
{
	...
	a=VPint_r(virtAddr3);
	b=VPint_r(virtAddr2);
	VPint_w(virtAddr1,VPint_r(virtAddr1)&0xffffffff);

	a=VPint_r(virtAddr3);
	b=VPint_r(virtAddr2);
	VPint_w(virtAddr2,(VPint_r(virtAddr2)|(1<<23)));
	VPint_w(virtAddr3,(VPint_r(virtAddr3)|1));
...
#ifdef CONFIG_PCI_MSI
	virtAddr1 = ioremap((phys_addr_t)0x1fa91420,4); //RC0 e1000e
	virtAddr2 = ioremap((phys_addr_t)0x1fa91424,4); //RC0 e1000e
	virtAddr3 = ioremap((phys_addr_t)0x1fa9142c,4); //RC0 e1000e
#endif
