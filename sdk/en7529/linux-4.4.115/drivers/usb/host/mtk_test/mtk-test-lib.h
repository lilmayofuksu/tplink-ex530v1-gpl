...
extern unsigned long g_xhci_u3h_base;
extern unsigned long g_xhci_ippc_base;
#define SSUSB_U3_XHCI_BASE      g_xhci_u3h_base
#define SSUSB_U3_MAC_BASE		g_xhci_u3h_base + 0x2400
#define SSUSB_U3_SYS_BASE		g_xhci_u3h_base + 0x2600
#define SSUSB_U2_SYS_BASE		g_xhci_u3h_base + 0x3400
#define SIFSLV_IPPC      		g_xhci_ippc_base
#else
...
#define SIFSLV_IPPC      		0xBFB93E00
#else
#ifdef TCSUPPORT_CPU_EN7580
#define SIFSLV_IPPC                     0xBFA84700
#else
