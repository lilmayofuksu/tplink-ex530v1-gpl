...
extern resource_size_t g_res_start;
extern resource_size_t g_res_size;
extern int g_xhci_irq;
#endif
...
#if TCSUPPORT_CPU_ARMV8
        hcd->rsrc_start = g_res_start;
        hcd->rsrc_len = g_res_size; 	
        hcd->regs = g_xhci_u3h_base;
        if (!hcd->regs) {			
