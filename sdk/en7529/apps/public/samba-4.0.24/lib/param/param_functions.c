...
FN_GLOBAL_BOOL(raw_ntlmv2_auth, bRawNTLMv2Auth)
...
FN_GLOBAL_BOOL(allow_dcerpc_auth_level_connect, bAllowDcerpcAuthLevelCconnect)
...
FN_GLOBAL_INTEGER(client_ipc_signing, client_ipc_signing)
