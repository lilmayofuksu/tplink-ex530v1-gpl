...
/* Here follows boolean settings that define how to behave during
  ...
  curl_sockconn_callback sock_conn_progress;  /* pointer to the socket connecting progress */
  long connect_mode;  /* 1=ip4 2=ipv6 */

  long speedtest_mode; /* 0=normal mode, 1=with speedtest mode  */
  long transfer_percent;
};
