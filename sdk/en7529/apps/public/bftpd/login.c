...
#ifdef _HAVE_UT_HOST   
		strncpy(ut.ut_host, remotehostname, sizeof(ut.ut_host) - 1);
#endif    
	} else {
#ifdef _HAVE_UT_TYPE
...
int bftpd_login(char *password)
{
...
#endif
	    	strncpy(str, config_getoption("ROOTDIR"), sizeof(str) - 1);
	...
	res = initgroups(userinfo.pw_name, userinfo.pw_gid);
	...
	/* print_file(230, config_getoption("MOTD_USER")); */
        strncpy(str, config_getoption("MOTD_USER"), sizeof(str) - 1);
