...
typedef enum
{
  ...
  G_DBUS_ERROR_SETMULTI_FAILED = 8000,           /* org.freedesktop.DBus.Error.SetMultiError */
  G_DBUS_ERROR_SETMULTI_ROLLBACK_FAILED = 8001,  /* org.freedesktop.DBus.Error.SetMultiRollbackError */
  G_DBUS_ERROR_SET_FAILED = 8100,                /* org.freedesktop.DBus.Error.SetError */
} GDBusError;
