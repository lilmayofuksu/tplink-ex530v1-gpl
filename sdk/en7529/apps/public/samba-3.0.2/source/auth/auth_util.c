					 ...
					 const uchar *dc_sess_key)
{
...

	{
		...
		memset(&nt_interactive_blob, 0, sizeof(DATA_BLOB));
		memset(&lm_interactive_blob, 0, sizeof(DATA_BLOB));
		memset(&local_nt_blob, 0, sizeof(DATA_BLOB));
		memset(&local_lm_blob, 0, sizeof(DATA_BLOB));
		if (lm_interactive_pwd) {
