				...
				prs_struct *ps, int depth)
{
	...
	res = prs_uint8s(False, "sig  ", ps, depth, chk->sig, sizeof(chk->sig));
	res = prs_uint8s(False, "seq_num", ps, depth, chk->seq_num, sizeof(chk->seq_num));
	res = prs_uint8s(False, "packet_digest", ps, depth, chk->packet_digest, sizeof(chk->packet_digest));
	res = prs_uint8s(False, "confounder", ps, depth, chk->confounder, sizeof(chk->confounder));
