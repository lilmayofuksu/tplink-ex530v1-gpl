...
#PORT_CFLAGS = -O3 -mips32r2 -EB -static -march=34kc -falign-jumps=8 -falign-functions=8 -fno-caller-saves -fsched-spec-load -fgcse-las -fgcse-sm -funroll-loops -G 1024 -mno-abicalls -mgpopt -mno-shared
PORT_CFLAGS = -O3 -funroll-all-loops -falign-jumps=16 -falign-loops=16 -falign-functions=16 -fgcse-sm -fgcse-las -finline-functions -finline-limit=1000 -msoft-float -EB
#PORT_CFLAGS = -O3 -flto
