...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=mips-linux' 'CC=mips-buildroot-linux-uclibc-gcc' '--with-endianness=big' '--with-ar=mips-buildroot-linux-uclibc-ar' 'host_alias=mips-linux' 'CFLAGS=-O2 -Wall -DTRENDCHIP -static -mips32r2 -msoft-float ' '--prefix=/proj/mtk69551/tony/ws_tony.du_AP31_IPv6/tclinux_phoenix/apps/public/net-snmp-5.7.3/install_dir' '--disable-shared' '--disable-applications' '--disable-debugging' '--enable-mini-agent' '--without-kmem-usage' '--with-default-snmp-version=3' '--with-sys-contact=econet' '--with-sys-location=taiwan' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/etc/net-snmp' '--with-openssl=PSSL_DIR' '--datadir=/etc/net-snmp' '--enable-ipv6'"
...
#define SNMPLIBPATH "/proj/mtk69551/tony/ws_tony.du_AP31_IPv6/tclinux_phoenix/apps/public/net-snmp-5.7.3/install_dir/lib/snmp"
#define SNMPSHAREPATH "/etc/net-snmp/snmp"
#define SNMPCONFPATH "/proj/mtk69551/tony/ws_tony.du_AP31_IPv6/tclinux_phoenix/apps/public/net-snmp-5.7.3/install_dir/etc/snmp"
#define SNMPDLMODPATH "/proj/mtk69551/tony/ws_tony.du_AP31_IPv6/tclinux_phoenix/apps/public/net-snmp-5.7.3/install_dir/lib/snmp/dlmod"
