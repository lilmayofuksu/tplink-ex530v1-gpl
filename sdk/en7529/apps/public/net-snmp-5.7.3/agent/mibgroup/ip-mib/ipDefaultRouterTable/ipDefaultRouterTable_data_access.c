               ...
               netsnmp_container *container)
{
    ...
    if ((NULL != rowreq_ctx) &&
		...
		DEBUGMSGTL(("ipDefaultRouterTable:access1", "container insert failed for new entry111\n"));
    } else {
        if (NULL != rowreq_ctx) {
...
ipDefaultRouterTable_container_load(netsnmp_container * container)
{
	...
	DEBUGMSGTL(("ipDefaultRouterTable:access", "ipDefaultRouterTable_container_load:defaultrouter_container != NULL\n"));
    DEBUGMSGT(("verbose:ipDefaultRouterTable:ipDefaultRouterTable_container_load",
               "%" NETSNMP_PRIz "d records1\n", CONTAINER_SIZE(container)));
