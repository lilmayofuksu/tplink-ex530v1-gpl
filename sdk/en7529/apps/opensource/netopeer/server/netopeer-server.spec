...
%build
./configure --with-distro=ubuntu --prefix=%{_prefix} --sysconfdir=%{_sysconfdir} --with-rpm  --disable-configurator --with-libnetconf=/proj/mtk69551/tony/Git/netconf/tclinux_phoenix/apps/opensource/NETCONF_LIB;
make
make doc
