...
#define CLSD 0
  ...
  for (i = 0; i < NUM_FP_TIMEDPROBES_IPv6 && i < NUM_FP_PROBES_IPv6_TCP; i++) {
...
int FPHost6::schedule() {
  ...
  if (this->timed_probes > 0 && this->timedprobes_sent == false) {
    ...
    if (this->netctl && this->netctl->request_slots(this->timed_probes) == true) {
      if (o.debugging > 3)
    ...
    if (this->probes_sent < this->total_probes) {
      if (this->netctl && this->netctl->request_slots(1) == true) {
        if (o.debugging > 3)
