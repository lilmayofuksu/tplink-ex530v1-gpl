...
Packager: Tony.Du <Tony.Du@econet-inc.com>
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}

BuildRequires: gcc make doxygen pkgconfig libxml2-devel libxslt-devel 
Provides:  libnetconf-notifications
...
%build
./configure --prefix=%{_prefix} --libdir=%{_libdir} --with-rpm --with-workingdir=/tmp/work_dir --disable-validation --disable-libssh --with-libxslt=/proj/mtk69551/tony/Git/netconf/tclinux_phoenix/apps/opensource/NETCONF_LIB/bin --with-libxml2=/proj/mtk69551/tony/Git/netconf/tclinux_phoenix/apps/opensource/NETCONF_LIB/bin  --disable-url;
make
make doc
