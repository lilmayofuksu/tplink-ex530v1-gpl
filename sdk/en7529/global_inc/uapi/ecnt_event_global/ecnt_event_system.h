...
/**
* \file  ecnt_event_system.h 
* \brief This file is ecnt system event header file that will be exported for others to use.
* \author Lei.Zhang
* \date     2020-09-24
* \version  A001 
...
typedef enum {
	ECNT_EVENT_PON_HSGMII,
	ECNT_EVENT_USB3_HSGMII,
	ECNT_EVENT_PCIE0_HSGMII,
	ECNT_EVENT_PCIE1_HSGMII,
