...
#define _SPI_NAND_MANUFACTURER_ID_ESMT_2		0x2C
...
#define _SPI_NAND_DEVICE_ID_F50L4G41XB		0x34
#define _SPI_NAND_DEVICE_ID_W25N01GV		0xAA
#define _SPI_NAND_DEVICE_ID2_W25N02KV		0x22
#define _SPI_NAND_DEVICE_ID2_W25N04KV		0x23
...
#define _SPI_NAND_DEVICE_ID_MT29F4G01ABAFDWB 0x34
...
struct SPI_NAND_FLASH_INFO_T {
	const u8								mfr_id;
	const u8								dev_id;
	const u8								dev_id2;		/* WINDBOND FLASH DEV ID USING 2BYTES */
	const u8								*ptr_name;
